...
def main():
    ...
    parser.add_argument("--rho", default=None, type=float, help="rho for SAM")
    parser.add_argument("--base_optimizer", default=None, type=str, help="base optimizer")
    parser.add_argument("--with_SAM", default="False", type=str, help="Use SAM optimizer")
    ...
    for key in config["Models"]:
        ...
        if args.rho != None:
            config["Models"][key]["optimizer_args"]["rho"] = args.rho
        if args.base_optimizer != None:
            config["Models"][key]["optimizer"] = args.base_optimizer
    ...
    if args.with_SAM == "True":
        config["Job"]["with_SAM"] = True
    else:
        config["Job"]["with_SAM"] = False
